...
2. In our UI, the player should be able to play the game by clicking on buttons rather than typing their answer in a prompt.  
   ...
   6. Once you're all done with your UI and make sure everything's satisfactory. After you commit all your changes to `rps-ui` branch it's time to merge our current branch `rps-ui` to our main branch.  
